...
Spec for the `art cat` command, which prints the raw content of an artifact's primary file (or a specific sub-path file within a directory-based artifact) to stdout.
