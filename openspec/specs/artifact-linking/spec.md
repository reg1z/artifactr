...
Artifact linking enables switching between symlinked and copied artifacts, with diff detection, backup support, glob pattern matching, and hard link detection utilities.
