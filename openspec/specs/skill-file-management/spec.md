...
Spec for the interactive file management features of `art edit` when working with directory-based artifacts (skills). Covers the file picker UI, sub-path targeting, new-file creation, file import, and file deletion within a skill directory.
