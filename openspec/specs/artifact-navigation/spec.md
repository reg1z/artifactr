...
Spec for `art nav` — a command that resolves and navigates to vault or artifact type directories, with configurable output modes and an optional shell wrapper integration.
