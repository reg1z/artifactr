...
Spec for `art vault export` and `art vault import` — commands for bundling vaults into portable `.zip` archives and extracting them on another machine or location.
