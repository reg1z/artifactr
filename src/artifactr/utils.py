...
def get_editor() -> str | None:
    ...
    Resolution order:
        ...
        4. edit (Windows fallback)
        5. notepad.exe (Windows fallback)
    ...
    if platform.system() == "Windows":
        for editor in ("edit", "notepad.exe"):
            if shutil.which(editor):
                return editor
...
def get_shell_wrapper_snippet(shell: str) -> str:
    ...
    if shell in ("bash", "sh", "dash"):
        ...
        return (
            ...
            "  if test \"$argv[1]\" = \"nav\"\n"
            "    for _arg in $argv[2..]\n"
            "      if test \"$_arg\" = \"--help\" -o \"$_arg\" = \"-h\"\n"
            "        command art $argv; return\n"
            "      end\n"
            "    end\n"
        ...
        return (
            ...
            "        & (Get-Command art -CommandType Application | Select-Object -First 1).Source @args; return\n"
            "      }\n"
            "    }\n"
